...
void DeepDist::update_goodvarstack1(int flipvar)
{
	int v;
...
void DeepDist::update_goodvarstack2(int flipvar)
{
...
void DeepDist::simple_print(char* filename)
{
	if (best_soln_feasible != 0)
	{
		if (verify_sol() == 1){
