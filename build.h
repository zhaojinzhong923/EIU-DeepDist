...
bool DeepDist::parse_parameters2(int argc, char **argv)
{
    int i = 0;
    int temp_para = 0;
    // cout << "c test:" << endl;
...
void DeepDist::build_neighbor_relation()
{
    int i, j, count;
    int v, c, n;
...
void DeepDist::build_instance(char *filename)
{
    total_soft_length = 0;
    total_hard_length = 0;
    // max_soft_weight = 1;
